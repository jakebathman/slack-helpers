...
<div class="justify-center p-10">
    ...
    <div class="text-center p-3">
        <a href="https://slack.com/oauth/v2/authorize?client_id={{ config('services.slack.client_id') }}&scope=channels:history,chat:write,commands,users:read,channels:read&user_scope=&redirect_uri={{ route('oauth.redirect') }}"><img class="inline" alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a>
    </div>
